...
import com.backend.farmon.validaton.validator.ChatRoomExistValidator;
...
@Constraint(validatedBy = ChatRoomExistValidator.class) // 검증 로직을 구현한 클래스 지정
@Target({ElementType.PARAMETER, ElementType.FIELD}) // 어노테이션 적용 범위
@Retention(RetentionPolicy.RUNTIME) // 런타임까지 유지
public @interface ExistChatRoom {
    String message() default "아이디와 일치하는 채팅방이 없습니다."; // 기본 에러 메시지
