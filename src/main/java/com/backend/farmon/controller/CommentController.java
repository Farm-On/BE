...
public class CommentController {
    ...
    public ApiResponse saveChildComment(@PathVariable String postId, @PathVariable Long parentNo, @RequestBody @Valid CommentRequestDTO.CommentSaveChildRequestDto request) {
        String resultcode = SuccessStatus._OK.getCode();
    ...
    public ApiResponse updateChildComment(@PathVariable String postId, @PathVariable Long parentNo, @PathVariable Long commentNo,
