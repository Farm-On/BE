...
public interface EstimateRepositoryCustom {
    ...
    Page<Estimate> findFilteredEstimates(Long expertId, String cropCategory, String cropName, String estimateName,String budget, String areaName, String areaNameDetail, Pageable pageable);
