...
public class WebSocketSessionManager {
    ...
    // 연결 시 세션과 사용자 정보 매핑
    public void storeUserSession(String sessionId, String token, String role, Long userId, Long chatRoomId) {
        SessionInfo sessionInfo = new SessionInfo(token, role, userId, chatRoomId);
